...
Find all comments with the `CLAUDE:` prefix in the codebase using
`rg "CLAUDE:"`.
Read the relevant files and surrounding context to understand what is being
asked.
If necessary, prompt the user
for more information to solidify your understanding.

Once you have a good understanding of what is being asked,
create a summary table and prompt the user for confirmation
...
you may omit sub-agents and execute everything in the main context.

After all tasks are complete,
produce a summary table of how each task was implemented
